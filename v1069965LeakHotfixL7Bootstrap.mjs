...
const prefix = "[v10.69.9.6.7-L7]";
console.log(`${prefix} bootstrap entered; loading archive + walk-forward gate + leak stack.`);
...
try {
  ...
  console.log(`${prefix} 6.7 walk-forward gate + L1-L7 loaders registered.`);
