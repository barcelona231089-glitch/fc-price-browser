...
const prefix = "[v10.69.9.6.5-L3]";
console.log(`${prefix} bootstrap entered; loading archive + L1 + L2 + fast leak horizons.`);
...
try {
  ...
  console.log(`${prefix} 6.5 + L1 + L2 + L3 loaders registered.`);
