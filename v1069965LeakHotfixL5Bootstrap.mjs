...
const prefix = "[v10.69.9.6.5-L5]";
console.log(`${prefix} bootstrap entered; loading archive + leak stack + official X API telemetry.`);
...
try {
  ...
  console.log(`${prefix} 6.5 + L1 + L2 + L3 + L4 + L5 loaders registered.`);
